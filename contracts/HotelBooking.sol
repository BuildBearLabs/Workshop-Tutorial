...
contract hotelBooking {
    ...
    function checkInRoyal() external {
        require(
            hotelRoomDetails[1].costumerBooked == msg.sender,
            "This room has not been booked by you."
        );
    ...
    function checkOutRoyal(uint _rating) external {
        ...
        hotelRoomDetails[1].review =
            (_rating +
                (hotelRoomDetails[1].review * hotelRoomDetails[1].reviewNo)) /
            (hotelRoomDetails[1].reviewNo + 1);
    ...
    function checkOutPremium(uint _rating) external {
        ...
        hotelRoomDetails[2].review =
            (_rating +
                (hotelRoomDetails[2].review * hotelRoomDetails[2].reviewNo)) /
            (hotelRoomDetails[2].reviewNo + 1);
    ...
    function checkOutDeluxe(uint _rating) external {
        ...
        hotelRoomDetails[3].review =
            (_rating +
                (hotelRoomDetails[3].review * hotelRoomDetails[3].reviewNo)) /
            (hotelRoomDetails[3].reviewNo + 1);
